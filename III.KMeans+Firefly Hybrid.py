...
#2nd one taken from dataset location with 6k data values

df = pd.read_csv("http://cs.joensuu.fi/sipu/datasets/MopsiLocations2012-Joensuu.txt",delimiter=r"\s+")
cols = [0,1]
...
print("Silhoutte :- ")
print(metrics.silhouette_score(X_DATA,clusters))
#error here is that C contains 3,2 matrix of centroids but i need points of cluster belonging; clusters had 
